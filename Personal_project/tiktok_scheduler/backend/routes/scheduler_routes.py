...
@scheduler_bp.route('/reschedule/<int:post_id>', methods=['PUT'])
@jwt_required()
...
@scheduler_bp.route('/update/<int:post_id>', methods=['PUT'])
@jwt_required()
...
@scheduler_bp.route('/cancel/<int:post_id>', methods=['DELETE'])
@jwt_required()
